...
// Se start.js está em /app/apps/api-gateway, subir dois níveis para /app
// Se start.js está em /app, usar diretamente
let projectRoot = __dirname;
if (__dirname.includes('/apps/api-gateway') || __dirname.includes('\\apps\\api-gateway')) {
  // Se estamos em /app/apps/api-gateway, subir dois níveis
  projectRoot = path.resolve(__dirname, '../..');
} else if (__dirname.includes('/apps/auth-service') || __dirname.includes('\\apps\\auth-service')) {
...
const serviceDir = path.resolve(projectRoot, 'apps', 'api-gateway');
